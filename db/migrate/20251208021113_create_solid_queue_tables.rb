class CreateSolidQueueTables < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :solid_queue_claimed_executions, %i[process_id job_id], name: "index_solid_queue_claimed_executions_on_process_id_and_job_id"
    ...
    add_index :solid_queue_semaphores, %i[key value], name: "index_solid_queue_semaphores_on_key_and_value"
    ...
    add_index :solid_queue_processes, %i[name supervisor_id], unique: true, name: "index_solid_queue_processes_on_name_and_supervisor_id"
